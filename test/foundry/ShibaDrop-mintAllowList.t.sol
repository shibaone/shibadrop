...
import { AllowListData, MintParams } from "shibadrop/lib/ShibaDropStructs.sol";
...
contract ERC721DropTest is TestHelper {
        ...
        validateAllowList(args)
    {
        ...
        shibadrop.updateAllowList(allowListData);
        ...
        shibadrop.mintAllowList{ value: mintValue }(
            address(token),
            args.feeRecipient,
            args.allowList[0],
            args.numMints,
        ...
        validateAllowList(args)
    {
        ...
        // Allow the payer.
        token.updatePayer(address(shibadrop), args.allowList[0], true);
        hoax(args.allowList[0], 100 ether);
