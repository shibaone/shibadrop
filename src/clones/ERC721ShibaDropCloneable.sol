...
import {
    ERC721ShibaDropStructsErrorsAndEvents
} from "../lib/ERC721ShibaDropStructsErrorsAndEvents.sol";
 ...
 */
contract ERC721ShibaDropCloneable is
    ERC721ContractMetadataCloneable,
    INonFungibleShibaDropToken,
    ERC721ShibaDropStructsErrorsAndEvents,
    ReentrancyGuardUpgradeable
{
    ...
    {
        return
            interfaceId == type(INonFungibleShibaDropToken).interfaceId ||
            interfaceId == type(IShibaDropTokenContractMetadata).interfaceId ||
