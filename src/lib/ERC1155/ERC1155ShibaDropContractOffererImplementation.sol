...
} from "./ERC1155ShibaDropContractOffererStorage.sol";

import {
    MintDetails,
    MintParams,
    PublicDrop
} from "./ERC1155ShibaDropStructs.sol";

import {
    ERC1155ShibaDropErrorsAndEvents
} from "./ERC1155ShibaDropErrorsAndEvents.sol";
 ...
 */
contract ERC1155ShibaDropContractOffererImplementation is
    ERC1155ShibaDropErrorsAndEvents
{
    ...
    IDelegationRegistry public constant DELEGATION_REGISTRY =
        IDelegationRegistry(0x4641888B2FbdEb6465a917524b9dEa399b41A03e);
    ...
    fallback(bytes calldata) external returns (bytes memory output) {
        ...
        if (selector == IERC1155ShibaDrop.getPublicDrop.selector) {
            ...
            return
                abi.encode(
                    ERC1155ShibaDropContractOffererStorage.layout()._publicDrops[
                        publicDropIndex
                    ]
                );
        } else if (selector == IERC1155ShibaDrop.getPublicDropIndexes.selector) {
        ...
        } else if (selector == IShibaDropToken.getAllowListMerkleRoot.selector) {
            // Return the creator payouts.
            return
                abi.encode(
                    ERC1155ShibaDropContractOffererStorage
        ...
        } else if (selector == IShibaDropToken.getAllowedFeeRecipients.selector) {
        ...
        } else if (selector == IShibaDropToken.getSigners.selector) {
        ...
        } else if (selector == IShibaDropToken.getDigestIsUsed.selector) {
            // Get the digest.
            ...
            return
                abi.encode(
                    ERC1155ShibaDropContractOffererStorage.layout()._usedDigests[
                        digest
                    ]
                );
        } else if (selector == IShibaDropToken.getPayers.selector) {
            // Return the allowed signers.
            return
                abi.encode(
                    ERC1155ShibaDropContractOffererStorage
    ...
    function updatePublicDrop(
        ...
        PublicDrop
            storage existingDropStageData = ERC1155ShibaDropContractOffererStorage
                .layout()
                ._publicDrops[index];
        uint256[]
            storage enumeratedIndexes = ERC1155ShibaDropContractOffererStorage
                .layout()
                ._enumeratedPublicDropIndexes;
        ...
        if (addOrUpdateDropStage) {
            ...
            delete ERC1155ShibaDropContractOffererStorage.layout()._publicDrops[
                index
            ];
    ...
    function updateAllowList(AllowListData calldata allowListData) external {
        ...
        bytes32 prevRoot = ERC1155ShibaDropContractOffererStorage
            .layout()
            ._allowListMerkleRoot;
    ...
    function _mintPublic(
        ...
        // Get the public drop.
        PublicDrop memory publicDrop = ERC1155ShibaDropContractOffererStorage
            .layout()
    ...
    function _mintSigned(
        ...
        if (
            ERC1155ShibaDropContractOffererStorage.layout()._usedDigests[digest]
        ) {
        ...
        if (
            !ERC1155ShibaDropContractOffererStorage.layout()._allowedSigners[
                recoveredAddress
            ]
        ) {
    ...
    function _checkPayerIsAllowed(address payer, address minter) internal view {
        if (
            ...
            payer != minter &&
            !ERC1155ShibaDropContractOffererStorage.layout()._allowedPayers[
                payer
            ] &&
    ...
    function _checkMintQuantity(
        ...
        (
            ...
            uint256 maxSupply
        ) = IERC1155ShibaDrop(address(this)).getMintStats(minter, tokenId);
    ...
    function _requiredConsideration(
        ...
        CreatorPayout[]
            storage creatorPayouts = ERC1155ShibaDropContractOffererStorage
                .layout()
                ._creatorPayouts;
    ...
    function updateCreatorPayouts(
        ...
        delete ERC1155ShibaDropContractOffererStorage.layout()._creatorPayouts;
        ...
        for (uint256 i; i < creatorPayoutsLength; ) {
            ...
            // Push to storage.
            ERC1155ShibaDropContractOffererStorage.layout()._creatorPayouts.push(
                creatorPayout
            );
    ...
    function updateAllowedFeeRecipient(
        ...
        address[]
            storage enumeratedStorage = ERC1155ShibaDropContractOffererStorage
                .layout()
                ._enumeratedFeeRecipients;
        mapping(address => bool)
            storage feeRecipientsMap = ERC1155ShibaDropContractOffererStorage
                .layout()
        ...
        if (allowed) {
            ...
            delete ERC1155ShibaDropContractOffererStorage
                .layout()
                ._allowedFeeRecipients[feeRecipient];
    ...
    function updateSigner(address signer, bool allowed) external {
        ...
        address[]
            storage enumeratedStorage = ERC1155ShibaDropContractOffererStorage
                ...
                ._enumeratedSigners;
        mapping(address => bool)
            storage signersMap = ERC1155ShibaDropContractOffererStorage
                .layout()
                ._allowedSigners;
    ...
    function updatePayer(address payer, bool allowed) external {
        ...
        address[]
            storage enumeratedStorage = ERC1155ShibaDropContractOffererStorage
                ...
                ._enumeratedPayers;
        mapping(address => bool)
            storage payersMap = ERC1155ShibaDropContractOffererStorage
                .layout()
                ._allowedPayers;
        ...
        if (allowed) {
            ...
            delete ERC1155ShibaDropContractOffererStorage.layout()._allowedPayers[
                payer
            ];
