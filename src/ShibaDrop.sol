...
import { IShibaDrop } from "./interfaces/IShibaDrop.sol";

import {
    INonFungibleShibaDropToken
} from "./interfaces/INonFungibleShibaDropToken.sol";
 ...
 * @notice ShibaDrop is a contract to help facilitate ERC721 token drops
 *         with functionality for public, allow list, server-side signed,
 *         and token-gated drops.
 */
contract ShibaDrop is IShibaDrop, ReentrancyGuard {
    ...
    function _checkMintQuantity(
        ...
        (
            ...
            uint256 maxSupply
        ) = INonFungibleShibaDropToken(nftContract).getMintStats(minter);
     ...
     *         ERC165 interface id matches INonFungibleShibaDropToken.
     *
     *         Note: Be sure only authorized users can call this from
     *         token contracts that implement INonFungibleShibaDropToken.
     *
