...
export function handleAllowedShibaDropUpdated(
  ...
  let allowedShibaDropBytesArray: Bytes[] = []
  for (let i = 0; i < event.params.allowedShibaDrop.length; i++) {
    allowedShibaDropBytesArray.push(event.params.allowedShibaDrop[i])
  }
  entity.allowedShibaDrop = allowedShibaDropBytesArray
