...
import {
    ShibaDropErrorsAndEventsUpgradeable
} from "../lib/ShibaDropErrorsAndEventsUpgradeable.sol";

interface IShibaDropUpgradeable is ShibaDropErrorsAndEventsUpgradeable {
    /**
     ...
     * and its ERC165 interface id matches INonFungibleShibaDropToken.
     */
     ...
     *         and emits an event.
     *
     *         Note: If two INonFungibleShibaDropToken tokens are doing simultaneous
