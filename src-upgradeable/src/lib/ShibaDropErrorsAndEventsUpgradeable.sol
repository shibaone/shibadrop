...
import { PublicDrop, TokenGatedDropStage, SignedMintValidationParams } from "./ShibaDropStructsUpgradeable.sol";

interface ShibaDropErrorsAndEventsUpgradeable {
    /**
     ...
     *      match the INonFungibleShibaDropToken interface.
     */
    ...
    /**
     * @dev An event with details of a ShibaDrop mint, for analytical purposes.
     * 
